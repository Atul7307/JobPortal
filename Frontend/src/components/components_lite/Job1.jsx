...
const Job1 = ({ job }) => {
  ...
  return (
    <div onClick={()=>navigate(`/description/${job._id}`)} className="w-[100%]  p-2 rounded-md shadow-xl  border border-gray-100">
      <div className="flex items-center justify-between bg-green">
